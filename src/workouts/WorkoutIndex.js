...
const WorkoutIndex = (props) => {
    ...
    const editUpdateWorkout = (workout) => {
        ...
        console.log(`WORKOUT: ${workout}  WORKOUT.ID: ${workout.id}`);
    }
    const updateOn = () => {
    ...
    return (
        <Container>
            <Row>
                ...
                {updateActive ? <WorkoutEdit workoutToUpdate={workoutToUpdate} updateOff={updateOff} token={'Bearer '+props.token} fetchWorkouts={fetchWorkouts}/> : <> </>}
            </Row>
        </Container>
    )
}
